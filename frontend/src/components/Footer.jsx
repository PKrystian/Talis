...
const Footer = () => {
  ...
  return (
    <footer className="footer bg-dark text-light mt-auto">
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 text-center my-2 my-md-0">
            ...
            <p className="mt-2">Powered by {' '}
              <a href='https://boardgamegeek.com/wiki/page/BGG_XML_API2' className="text-light" target="_blank" rel="noopener noreferrer">
                BoardGameGeek
              </a>
            </p>
          </div>
      ...
      {showTopBtn && (
        <button onClick={scrollToTop} className="btn btn-light btn-sm jump-to-top"><GoMoveToTop /></button>
      )}
    </footer>
  );
};
