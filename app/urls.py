...
urlpatterns = [
    ...
    path(API_PREFIX + UserController.ROUTE_DETAIL, views.user_profile_detail, name='user-profile-detail'),
    path(API_PREFIX + UserController.ROUTE_UPDATE_USER, views.update_user, name='update-user'),
